 ...
 function init(){
    for (let index = 0; index < 20; index++) {
        $task.fetch(myRequest).then(response => {
            console.log("300:[3386]"+response.statusCode + "\n\n" + response.body);
        }, reason => {
